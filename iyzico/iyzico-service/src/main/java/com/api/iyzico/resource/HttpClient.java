package com.api.iyzico.resource;

import com.api.iyzico.dto.HttpMethodType;
import com.google.gson.Gson;
import com.api.iyzico.exception.HttpClientException;
...
import static com.api.iyzico.dto.HttpMethodType.*;
...
public class HttpClient {
    ...
    private <T> T exchange(String url, Proxy proxy, HttpMethodType httpMethod, Map<String, String> headers, Object request, Class<T> responseType) {
        Gson gson = new Gson();
    ...
    private String send(String url, Proxy proxy, HttpMethodType httpMethod, InputStream content, Map<String, String> headers) {
        URLConnection raw;
    ...
    private void prepareRequestBody(HttpMethodType httpMethod, InputStream content, HttpURLConnection conn) throws IOException {
        if (HttpMethodType.isValidRequestFor(httpMethod)) {
